...
# URL del equipo aliado — configurable via variable de entorno para no hardcodear
_ALLIED_URL = os.getenv("ALLIED_SERVICE_URL", "http://localhost:8001/api/status/")
_TIMEOUT = 5


class AlliedServiceAdapter(AlliedServicePort):
    """
    Adapter sobre el servicio REST del equipo aliado.
